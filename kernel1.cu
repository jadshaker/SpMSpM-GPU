...
{
    // Use simple tiling by loading row pointers into shared memory
    ...
    // Load row pointers into shared memory collaboratively
    ...
    // Use shared memory for row pointers if possible
